...
function showlist(index, item) {
    var showlist = "<tr id=\"t" + item.id + "\" class='noExl'><td><input type=\"checkbox\" name=\"piliang\" value=\"" + item.id + "\"/></td><td>" + item.id + "</td><td><a href=\"" + item.id + "\" onclick=\"editfunc(this);return false;\"><span class=\"glyphicon glyphicon-edit\"></span></a>" +
        "</td><td><a href=\"" + item.id + "\" onclick=\"deletefunc(this);return false;\"><span class=\"glyphicon glyphicon-trash\"></span></a>" + "</td><td>" + item.tjyear + "</td><td>" + item.tjmonth + "</td><td>" + item.tjday + "</td><td>" + item.city +
        "</td><td>" + item.ytName + "</td><td>" + item.country + "</td><td>" + item.village +
        "</td><td>" + item.address + "</td><td>" + item.longitude + "</td><td>" + item.latitude + "</td><td>" + item.ytArea + "</td><td>" + item.position + "</td><td>" + item.psqx + "</td><td>" + item.riverMode +
        "</td><td>" + item.riverName + "</td><td>" + item.riverLevel + "</td><td>" + item.seaMode + "</td><td>" + item.seaName + "</td><td>" + item.riverFunc + "</td><td>" + item.riverGoal + "</td><td>" + item.jaFunction + "</td><td>" + item.seaGoal + "</td><td>" + item.seaFunctiontype + "</td><td>" + item.seaFunctiongoal + "</td></tr>";
    return showlist;
}
$(function () {
     ...
     *显示整个列表
     */
    var url = 'rest/pwkoilfield/pwkshowlist';
    $.ajax({
        url: url,
        type: "POST",
        dataType: "json",
    ...
    $("#btn_excelout").click(function () {
        var excelout = "rest/pwkoilfield/excelout";
    ...
    $("#submitPwk").click(function () {
        var addurl = "rest/pwkoilfield/addpwk";
        var addpwkmsc = {};
        /*********************************************/
        ...
        addpwkmsc.ytName = t[4].value;
        addpwkmsc.country = t[5].value;
        addpwkmsc.village = t[6].value;
        addpwkmsc.address = t[7].value;
        addpwkmsc.longitude =  parseFloat(t[8].value);
        addpwkmsc.latitude =  parseFloat(t[9].value);
        addpwkmsc.ytArea = parseFloat(t[10].value);
        ...
        addpwkmsc.riverFunc = t[18].value;
        addpwkmsc.riverGoal =  t[19].value;
        addpwkmsc.jaFunction = t[20].value;
        addpwkmsc.seaGoal = t[21].value;
        addpwkmsc.seaFunctiontype = t[22].value;
        addpwkmsc.seaFunctiongoal = t[23].value;
        /*********************************************/
    ...
    $("#submitPwk2").click(function () {
        ...
        selectpwkmsc.ytName = $("#select4").val();
        selectpwkmsc.country = $("#select5").val();
        selectpwkmsc.village = $("#select6").val();
        selectpwkmsc.address = $("#select7").val();
        selectpwkmsc.longitude =  parseFloat($("#select8").val());
        selectpwkmsc.latitude =  parseFloat($("#select9").val());
        selectpwkmsc.ytArea =  parseFloat($("#select10").val());
        ...
        selectpwkmsc.riverFunc = $("#select18").val();
        selectpwkmsc.riverGoal = $("#select19").val();
        selectpwkmsc.jaFunction = $("#select20").val();
        selectpwkmsc.seaGoal = $("#select21").val();
        selectpwkmsc.seaFunctiontype = $("#select22").val();
        selectpwkmsc.seaFunctiongoal = $("#select23").val();

        console.log(selectpwkmsc);

        var optionUrl = "rest/pwkoilfield/optionpwk";
    ...
    $("#submitPwk1").click(function () {
        ...
        var updateurl = "rest/pwkoilfield/updatepwk"
        ...
        updatepwkmsc.ytName = $("#pwk4").val();
        updatepwkmsc.country = $("#pwk5").val();
        updatepwkmsc.village = $("#pwk6").val();
        updatepwkmsc.address = $("#pwk7").val();
        updatepwkmsc.longitude =  parseFloat($("#pwk8").val());
        updatepwkmsc.latitude =  parseFloat($("#pwk9").val());
        updatepwkmsc.ytArea = parseFloat($("#pwk10").val());
        updatepwkmsc.position = $("#pwk12").val();
        ...
        updatepwkmsc.riverFunc =  $("#pwk18").val();
        updatepwkmsc.riverGoal = $("#pwk19").val();
        updatepwkmsc.jaFunction = $("#pwk20").val();
        updatepwkmsc.seaGoal = $("#pwk21").val();
        updatepwkmsc.seaFunctiontype = $("#pwk22").val();
        updatepwkmsc.seaFunctiongoal = $("#pwk23").val();
    ...
    function deletePwk(ids) {
        $.ajax({
            url: "rest/pwkoilfield/deletepwk",
            data: {"ids": ids},
            type: "POST",
            // dataType: "json",
            traditional: true,
