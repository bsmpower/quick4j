...
html += "<tr><td>泄洪口名称</td><td>${xhkName}</td></tr>";
html += "<tr><td>泄洪口编号</td><td>${xhkCode}</td></tr>";
html += "<tr><td>所在县（市/区）</td><td>${county}</td></tr>";
html += "<tr><td>所在乡镇</td><td>${village}</td></tr>";
html += "<tr><td>详细地址</td><td>${address}</td></tr>";
html += "<tr><td>泄洪口范围</td><td>${xhkArea}</td></tr>";
html += "<tr><td>泄洪口经度(E)</td><td>${longitude}</td></tr>";
html += "<tr><td>泄洪口纬度(N)</td><td>${latitude}</td></tr>";
html += "<tr><td>泄洪去向</td><td>${xhQx}</td></tr>";
html += "<tr><td>入河方式</td><td>${riverMode}</td></tr>";
html += "<tr><td>所在河流名称</td><td>${riverName}</td></tr>";
html += "<tr><td>河流级别</td><td>${riverLevel}</td></tr>";
html += "<tr><td>入海方式</td><td>${seaMode}</td></tr>";
html += "<tr><td>排入海域名称</td><td>${seaName}</td></tr>";
html += "<tr><td>泄洪水量(m³/次)</td><td>${xhNum}</td></tr>";
html += "<tr><td>泄洪次数(次/年)</td><td>${xhTimes}</td></tr>";
html += "<tr><td>泄洪河道水质标准</td><td>${standard}</td></tr>";
html += "<tr><td>泄洪口水功能区</td><td>${xhGnq}</td></tr>";
html += "<tr><td>泄洪口水质目标</td><td>${xhSzmb}</td></tr>";
html += "<tr><td>泄入海域近岸海域环境功能区</td><td>${hyGnq}</td></tr>";
html += "<tr><td>泄入海域水质目标</td><td>${hySzmb}</td></tr>";
html += "<tr><td>泄入海域海洋功能区类别</td><td>${hyGnq}</td></tr>";
html += "<tr><td>排入海域水质目标</td><td>${hySzmb}</td></tr>";
html += "<tr><td>排入海域海洋功能区类别</td><td>${hyseaGnq}</td></tr>";
html += "<tr><td>泄入海域海洋功能区水质目标</td><td>${hyseaSzmb}</td></tr>";
html += "</table>";
...
function showlist(index, item) {
    var showlist = "<tr id=\"t" + item.id + "\" class='noExl'><td><input type=\"checkbox\" name=\"piliang\" value=\"" + item.id + "\"/></td><td>" + item.id + "</td><td><a href=\"" + item.id + "\" onclick=\"editfunc(this);return false;\"><span class=\"glyphicon glyphicon-edit\"></span></a>" +
        ...
        "</td><td>" + item.xhkName + "</td><td>" + item.xhkCode + "</td><td>" + item.county + "</td><td>" + item.village +
        "</td><td>" + item.address + "</td><td>" + item.xhkArea + "</td><td>" + item.longitude + "</td><td>" + item.latitude + "</td><td>" + item.xhQx + "</td><td>" + item.riverMode + "</td><td>" + item.riverName + "</td><td>" + item.riverLevel + "</td><td>" + item.seaMode +
        "</td><td>" + item.seaName + "</td><td>" + item.xhNum + "</td><td>" + item.xhTimes + "</td><td>" + item.standard + "</td><td>" + item.xhGnq + "</td><td>" + item.xhSzmb +
...
$(function () {
     ...
     *显示整个列表
     */
    var url = 'rest/pwkrainxhk/pwkshowlist';
    $.ajax({
        url: url,
        type: "POST",
        dataType: "json",
...
function initMap() {
    require([
        ...
        // mapAllpoint.name="辽宁";
        $.ajax({
            url:"rest/pwkrainxhk/maptabledemo",
            type: "POST",
                ...
                if (data == "") {
                    ...
                    for(var i = 0; i < data.length; i++){
                        ...
                        attr = {
                            ...
                            "tjday": data[i].tjday,
                            "city":data[i].city,
                            "xhkName":data[i].xhkName,
                            "xhkCode":data[i].xhkCode,
                            "county":data[i].county,
                            "village":data[i].village,
                            "address":data[i].address,
                            "xhkArea":data[i].xhkArea,
                            ...
                            "xhNum": data[i].xhNum,
                            "xhTimes":data[i].xhTimes,
                            "standard":data[i].standard,
                            "xhGnq":data[i].xhGnq,
                            "xhSzmb":data[i].xhSzmb,
                            "hyGnq":data[i].hyGnq,
                        ...
                        var infoTemplate = new InfoTemplate("雨水泄洪口信息", html);
