...
<head>
    ...
    <script src="bsmassets/js/enterprise/industryPark.js"></script>
...
<div id="table-cont" class="table-cont">
    <table class="table table-striped table-bordered table-hover  table-condensed" id="tablediv">
        <thead>
        <tr class="success">
            <th>选择</th><th>ID</th><th>编辑</th><th>删除</th><th>统计年份</th><th>统计月份</th><th>统计日</th><th>工业园区名称</th><th>园区编号</th><th>所在市</th><th>所在县(市/区)</th><th>详细地址</th><th>经度(E)</th>
            <th>纬度(N)</th><th>园区范围</th><th>产业布局</th><th>集中污(雨)水处理设施名称</th><th>集中污(雨)水处理设施经度</th><th>集中污(雨)水处理设施纬度</th><th>园区雨(污)水是否收集</th><th>园区雨(污)水是否排放</th><th>污(雨)水处理设施设计规模(万吨/日)</th>
            <th>日均污(雨)水排放量(吨/日)</th><th>年均污(雨)水排放量(吨/年)</th><th>年污(雨)水排放时间</th><th>集中污(雨)水处理工艺</th>
        </tr>
        </thead>
        <tbody id="tbodyone">
        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitIndustryPark" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="editIndustryPark" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交更改
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="searchIndustryPark" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交更改
                    </button>
                </div>
            </div>
