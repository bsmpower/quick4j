...
<div id="toolbar" class="btn-group">
    ...
    <button id="btn_add" type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal6">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
    </button>
    <button id="btn_edit5" type="button" class="btn btn-default" data-toggle="modal" data-target="editIndustryParkModel">
        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
    </button>
    <button id="btn_delete4" type="button" class="btn btn-default" data-toggle="modal" data-target="myModalsearch">
...
<!--数据显示区域-->
<div>
    <table id="IndustryParkTable" class="table table-striped">

    </table>
</div>
<!--添加新的数据-->
<div>
    <div class="modal fade" id="myModal6" tabindex="-1" role="dialog" data-backdrop="static"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="bs-example bs-example-form" role="form">
                        ...
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">工业园区名称</span>
                            <input name="gyyqName" type="text" class="form-control" placeholder="工业园区名称">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                        ...
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">园区范围</span>
                            <input name="yqArea" type="text" class="form-control" placeholder="园区范围">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">产业布局</span>
                            <input name="cybj" type="text" class="form-control" placeholder="产业布局">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">集中污(雨)水处理设施名称</span>
                            <input name="facilityName" type="text" class="form-control" placeholder="集中污(雨)水处理设施名称">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">集中污(雨)水处理设施经度</span>
                            <input name="facilityLongitude" type="text" class="form-control" placeholder="集中污(雨)水处理设施经度">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">集中污(雨)水处理设施纬度</span>
                            <input name="facilityLatitude" type="text" class="form-control" placeholder="集中污(雨)水处理设施纬度">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">园区雨(污)水是否收集</span>
                            <input name="isCollection" type="text" class="form-control" placeholder="园区雨(污)水是否收集">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">园区雨(污)水是否排放</span>
                            <input name="isEmission" type="text" class="form-control" placeholder="园区雨(污)水是否排放">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">污(雨)水处理设施设计规模(万吨/日)</span>
                            <input name="sjgm" type="text" class="form-control" placeholder="污(雨)水处理设施设计规模(万吨/日)">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">日均污(雨)水排放量(吨/日)</span>
                            <input name="dailyEmission" type="text" class="form-control" placeholder="日均污(雨)水排放量(吨/日)">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">年均污(雨)水排放量(吨/年)</span>
                            <input name="annualEmission" type="text" class="form-control" placeholder="年均污(雨)水排放量(吨/年)">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">年污(雨)水排放时间</span>
                            <input name="emissionDays" type="text" class="form-control" placeholder="年污(雨)水排放时间">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">集中污(雨)水处理工艺</span>
                            <input name="process" type="text" class="form-control" placeholder="集中污(雨)水处理工艺">
                            <span class="input-group-addon">注释</span>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button id="submitIndustryPark" type="button" class="btn btn-primary">
                        提交
                    </button>
                </div>
            </div>
...
<!--修改数据信息-->
<div>
    <div class="modal fade" id="editIndustryParkModel" tabindex="-1" role="dialog" data-backdrop="static"
         aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">工业园区名称</span>
                                        <input id="gyyqName_changed" name="gyyqName" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">园区范围</span>
                                        <input id="yqArea_changed" name="yqArea" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">产业布局</span>
                                        <input id="cybj_changed" name="cybj" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">集中污(雨)水处理设施名称</span>
                                        <input id="facilityName_changed" name="facilityName" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">集中污(雨)水处理设施经度</span>
                                        <input id="facilityLongitude_changed" name="facilityLongitude" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">集中污(雨)水处理设施纬度</span>
                                        <input id="facilityLatitude_changed" name="facilityLatitude" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">园区雨(污)水是否收集</span>
                                        <input id="isCollection_changed" name="isCollection" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">园区雨(污)水是否排放</span>
                                        <input id="isEmission_changed" name="isEmission" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">污(雨)水处理设施设计规模(万吨/日)</span>
                                        <input id="sjgm_changed" name="sjgm" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">日均污(雨)水排放量(吨/日)</span>
                                        <input id="dailyEmission_changed" name="dailyEmission" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">集中污(雨)水处理工艺</span>
                                        <input id="process_changed" name="process" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="editIndustryPark" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox4" value="option4" onclick="exe()"> 工业园区名称
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox5" value="option5" onclick="exe()"> 园区编号
                        </label>
                    </div>
                    <br>
                    <div>
                    ...
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox11" value="option11" onclick="exe()"> 园区范围
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox12" value="option12" onclick="exe()"> 产业布局
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox13" value="option13" onclick="exe()"> 集中污(雨)水处理设施名称
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox14" value="option14" onclick="exe()">集中污(雨)水处理设施经度
                        </label>
                    </div>
                    <br>
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox15" value="option15" onclick="exe()"> 集中污(雨)水处理设施纬度
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox16" value="option16" onclick="exe()">园区雨(污)水是否收集
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox17" value="option17" onclick="exe()"> 园区雨(污)水是否排放
                        </label>
                    </div>
                    <br>
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox18" value="option18" onclick="exe()">污(雨)水处理设施设计规模(万吨/日)
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox19" value="option19" onclick="exe()">日均污(雨)水排放量(吨/日)
                        </label>
                    </div>
                    <br>
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox20" value="option20" onclick="exe()"> 年均污(雨)水排放量(吨/年)
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox21" value="option21" onclick="exe()"> 年污(雨)水排放时间
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox22" value="option22" onclick="exe()"> 集中污(雨)水处理工艺
                        </label>
                    </div>
                </div>
                <br>
                ...
                <div class="modal-footer">
                    ...
                    <button id="searchIndustryPark" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
    ...
    function exe() {
        ...
        if (val4 == true) {
            var temp4 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">工业园区名称</span>\n" +
                "<input id=\"select3\" name=\"gyyqName\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_3").html(temp4);
            $("#div_3").show();
        ...
        if (val5 == true) {
            var temp5 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">园区编号</span>\n" +
                "<input id=\"select4\" name=\"code\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_4").html(temp5);
            $("#div_4").show();
        ...
        if (val7 == true) {
            var temp7 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">所在县(市/区)</span>\n" +
                "<input id=\"select6\" name=\"country\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_6").html(temp7);
            $("#div_6").show();
        ...
        if (val11 == true) {
            var temp11 = "    <div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">园区范围</span>\n" +
                "<input id=\"select10\" name=\"yqArea\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_10").html(temp10);
            $("#div_10").show();
        ...
        if (val12 == true) {
            var temp12 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">产业布局</span>\n" +
                "<input id=\"select11\" name=\"cybj\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_11").html(temp12);
        ...
        if (val13 == true) {
            var temp13 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">集中污(雨)水处理设施名称</span>\n" +
                "<input id=\"select12\" name=\"facilityName\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_12").html(temp13);
        ...
        if (val14 == true) {
            var temp14 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">集中污(雨)水处理设施经度</span>\n" +
                "<input id=\"select13\" name=\"facilityLongitude\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_13").html(temp14);
        ...
        if (val15 == true) {
            var temp15 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">集中污(雨)水处理设施纬度</span>\n" +
                "<input id=\"select14\" name=\"facilityLatitude\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_14").html(temp15);
        ...
        if (val16 == true) {
            var temp16 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">园区雨(污)水是否收集</span>\n" +
                "<input id=\"select15\" name=\"isCollection\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_15").html(temp16);
        ...
        if (val17 == true) {
            var temp17 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">园区雨(污)水是否排放</span>\n" +
                "<input id=\"select16\" name=\"isEmission\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_16").html(temp17);
        ...
        if (val18 == true) {
            var temp18 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">污(雨)水处理设施设计规模(万吨/日)</span>\n" +
                "<input id=\"select17\" name=\"sjgm\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_17").html(temp18);
        ...
        if (val19 == true) {
            var temp19 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">日均污(雨)水排放量(吨/日)</span>\n" +
                "<input id=\"select18\" name=\"dailyEmission\" type=\"text\" class=\"form-control\"\n" +
                "placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_18").html(temp19);
        ...
        if (val20 == true) {
            var temp20 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">年均污(雨)水排放量(吨/年)</span>\n" +
                "<input id=\"select19\" name=\"annualEmission\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_19").html(temp20);
        ...
        if (val21 == true) {
            var temp21 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">年污(雨)水排放时间</span>\n" +
                "<input id=\"select20\" name=\"emissionDays\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_20").html(temp21);
        ...
        if (val22 == true) {
            var temp22 = "<div class=\"input-group\">\n" +
                "<span class=\"input-group-addon\">集中污(雨)水处理工艺</span>\n" +
                "<input id=\"select21\" name=\"process\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "<span class=\"input-group-addon\">注释</span>\n" +
                "</div>"
            $("#div_21").html(temp22);
            $("#div_21").show();
