...
<div id="toolbar" class="btn-group">
    ...
    <button id="btn_add" type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal1">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
    </button>
    <button id="btn_edit1" type="button" class="btn btn-default" data-toggle="modal" data-target="editLivestockModel">
        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
    </button>
    <button id="btn_delete1" type="button" class="btn btn-default" data-toggle="modal" data-target="myModalsearch">
...
<!--数据显示区域-->
<div>
    <table id="LivestockTable" class="table table-striped">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitLivestock" type="button" class="btn btn-primary">
                        提交
                    </button>
                </div>
            </div>
...
<!--修改数据信息-->
<div>
    <div class="modal fade" id="editLivestockModel" tabindex="-1" role="dialog" data-backdrop="static"
         aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button id="editLivestock" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="searchLivestock" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
