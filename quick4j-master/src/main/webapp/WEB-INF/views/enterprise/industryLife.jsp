...
<div id="toolbar" class="btn-group">
    ...
    <button id="btn_edit" type="button" class="btn btn-default" data-toggle="modal" data-target="editIndustryLifeModel">
...
<!--数据显示区域-->
<div>
    <table id="IndustryLifeTable" class="table table-striped">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="bs-example bs-example-form" role="form">
                        <div class="input-group">
                            ...
                            <input name="tjyear" type="text" class="form-control" placeholder="统计年份" required="true" >
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitIndustryLife" type="button" class="btn btn-primary">
                        提交
                    </button>
                </div>
            </div>
...
<!--修改数据信息-->
<div>
    <div class="modal fade" id="editIndustryLifeModel" tabindex="-1" role="dialog" data-backdrop="static"
         aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button id="editIndustryLife" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="searchIndustryLife" type="button" class="btn btn-primary">
                        提交更改
                    </button>
                </div>
            </div>
