...
<head>
    ...
    <script src="bsmassets/js/enterprise/municipal.js"></script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitMunicipal" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="editMunicipal" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交更改
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="searchMunicipal" type="button" class="btn btn-primary" data-dismiss="modal">
                        提交更改
                    </button>
                </div>
            </div>
