                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                        ...
                        <li class="">
                            <a href="javascript:;" id="companyparent">
                                <i class="fa fa-comment"></i><span class="title"> 相关排放企业信息管理 </span><span
                                    class="arrow "> </span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="javascript:;" id="companydr">
                                        排放企业基本信息导入
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" id="companylr" >
                                        排放企业基本信息录入
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" id="companywh">
                                        排放企业基本信息查询与维护
                                    </a>
                                </li>
                            </ul>
