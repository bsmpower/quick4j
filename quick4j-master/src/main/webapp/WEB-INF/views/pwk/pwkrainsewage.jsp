                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="position" list="khwz2" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="khwz2">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="seaName" list="haiyu2" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="haiyu2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="riverGnq" list="sgnq2" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="sgnq2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="riverSzmb" list="hlszmb2" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="hlszmb2">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">所在市</span>
                                        <input id="pwk5" list="citylist3" name="city" type="text" class="form-control"
                                               placeholder="">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-addon">河流级别</span>
                                        <input id="pwk15" list="hljb3" name="riverLevel" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <datalist id="hljb3">
                                            <option value="干流">干流</option>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">年均排污口排水量(吨/年)</span>
                                        <input id="pwk19" name="pwkNjpsl" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入河流水功能区</span>
                                        <input id="pwk24" list="sgnq3" name="riverGnq" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="sgnq3">
                                            <option value="饮用水源区">饮用水源区</option>
                                            <option value="工业用水区">工业用水区</option>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入河流水质目标</span>
                                        <input id="pwk25" list="hlszmb3" name="riverSzmb" type="text"
                                               class="form-control"
                                               placeholder="">
                                        <datalist id="hlszmb3">
                                            <option value="Ⅰ类">Ⅰ类</option>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入海域近岸海域环境功能区</span>
                                        <input id="pwk26" list="gnq3" name="hyGnq" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="gnq3">
                                            <option value="一类">一类</option>
                                            <option value="二类">二类</option>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入海域水质目标</span>
                                        <input id="pwk27" list="mb3" name="hySzmb" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="mb3">
                                            <option value="第一类">第一类</option>
                                            <option value="不低于第二类">不低于第二类</option>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入海域海洋功能区类别</span>
                                        <input id="pwk28" list="gnqtype3" name="hyseaGnq" type="text"
                                               class="form-control"
                                               placeholder="">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">排入海域海洋功能区水质目标</span>
                                        <input id="pwk29" list="szmb3" name="hyseaSzmb" type="text" class="form-control"
                                               placeholder="">
                                        <datalist id="szmb3">
                                            <option value="不劣于第一类">不劣于第一类</option>
                                            <option value="不劣于第二类">不劣于第二类</option>
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <div>
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox29" value="option29" onclick="exe()">
                                排入海域海洋功能区类别
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox30" value="option30" onclick="exe()">
                                排入海域海洋功能区水质目标
                            </label>
                        </div>
                    </div>
    ...
    function exe() {
        ...
        if (val25 == true) {
            var temp25 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入河流水功能区</span>\n" +
                "                                        <input id=\"select24\" list=\"sgnq1\" name=\"position\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "                                        <datalist id=\"sgnq1\">\n" +
                "                                                <option value=\"饮用水源区\">饮用水源区</option>\n" +
                "                                                <option value=\"工业用水区\">工业用水区</option>\n" +
        ...
        if (val26 == true) {
            var temp26 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入河流水质目标</span>\n" +
                "                                        <input id=\"select25\" list=\"hlszmb1\" name=\"processTech\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "                                        <datalist id=\"hlszmb1\">\n" +
                "                                                <option value=\"Ⅰ类\">Ⅰ类</option>\n" +
                "                                                <option value=\"Ⅱ类\">Ⅱ类</option>\n" +
        ...
        if (val27 == true) {
            var temp27 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入海域近岸海域环境功能区</span>\n" +
                "                                        <input id=\"select26\" list=\"gnq1\" name=\"emissionMode\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "                                        <datalist id=\"gnq1\">\n" +
                "                                                <option value=\"一类\">一类</option>\n" +
                "                                                <option value=\"二类\">二类</option>\n" +
        ...
        if (val28 == true) {
            var temp28 = " <div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入海域水质目标</span>\n" +
                "                                        <input id=\"select27\" list=\"mb1\" name=\"pwqx\" type=\"text\" class=\"form-control\" placeholder=\"\">\n" +
                "                                        <datalist id=\"mb1\">\n" +
                "                                                <option value=\"第一类\">第一类</option>\n" +
                "                                                <option value=\"不低于第二类\">不低于第二类</option>\n" +
                "                                                <option value=\"不低于第三类\">不低于第三类</option>\n" +
        ...
        if (val29 == true) {
            var temp29 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入海域海洋功能区类别</span>\n" +
                "                                        <input id=\"select28\" list=\"gnqtype1\" name=\"riverMode\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
        ...
        if (val30 == true) {
            var temp30 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">排入海域海洋功能区水质目标</span>\n" +
                "                                        <input id=\"select29\" list=\"szmb1\" name=\"riverName\" type=\"text\" class=\"form-control\"\n" +
                "                                               placeholder=\"\">\n" +
                "                                        <datalist id=\"szmb1\">\n" +
                "                                                <option value=\"不劣于第一类\">不劣于第一类</option>\n" +
                "                                                <option value=\"不劣于第二类\">不劣于第二类</option>\n" +
