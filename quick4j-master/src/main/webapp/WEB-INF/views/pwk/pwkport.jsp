            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="bs-example bs-example-form" role="form">
                        ...
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">港口/码头名称</span>
                            <input name="gkGame" type="text" class="form-control" placeholder="">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">港口/码头编号</span>
                            <input name="gkCode" type="text" class="form-control" placeholder="">
                            <span class="input-group-addon">注释</span>
                        </div>
                        <br>
                        <div class="input-group">
                        ...
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">港口/码头纬度(N)</span>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">港口/码头名称</span>
                                        <input id="pwk3" name="gkGame" type="text" class="form-control" placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">港口/码头编号</span>
                                        <input id="pwk4" name="gkCode" type="text" class="form-control" placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">所在县(市/区)</span>
                                        <input id="pwk6" name="country" type="text" class="form-control" placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-addon">港口/码头范围</span>
                                        <input id="pwk11" name="gkArea" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">所在河流名称</span>
                                        <input id="pwk12" name="riverName" type="text" class="form-control"
                                               placeholder="">
                                        <span class="input-group-addon">注释</span>
                                    </div>
                                    <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox4" value="option4" onclick="exe()"> 港口/码头名称
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox5" value="option5" onclick="exe()"> 港口/码头编号
                        </label>
                        <label class="checkbox-inline">
                    ...
                    <div>
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox10" value="option10" onclick="exe()"> 港口/码头经度(E)
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox11" value="option11" onclick="exe()"> 港口/码头纬度(N)
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox12" value="option12" onclick="exe()"> 港口/码头范围
                        </label>
                    </div>
                    <br>
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox13" value="option13" onclick="exe()"> 所在河流名称
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox14" value="option14" onclick="exe()"> 河流级别
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox15" value="option15" onclick="exe()"> 港口/码头所在河流水功能区
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox16" value="option16" onclick="exe()"> 港口/码头所在河流水质目标
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox17" value="option17" onclick="exe()"> 所在海域名称
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox18" value="option18" onclick="exe()"> 近岸海域环境功能区
                        </label>
                    </div>
                    <br>
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox19" value="option19" onclick="exe()"> 近岸海域水质目标
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox20" value="option20" onclick="exe()"> 海洋功能区类别
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox21" value="option21" onclick="exe()"> 海洋功能区水质目标
                        </label>
                ...
                <div class="modal-body">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td width="55%" align="center">港口码头信息表.xls</td>
                            <td width="15%" align="center">
                                <a type="button" class="btnz btnz-info" id="download" href="download/港口码头信息表.xls"
...
<script type="text/javascript">
    $(function () {
        $('#RainPwkInfoTable').bootstrapTable({
            url: '/rest/pwkport/pwkshowlist', // 请求后台的URL（*）
            method: 'get', // 请求方式（*）
            ...
            columns: [
                {
                    ...
                    field: 'seaFunctiontype',
                    title: '排入海域海洋功能区类别',
                    align: 'center',
                    valign: 'middle'
                }, {
                    field: 'seaFunctiongoal',
                    title: '排入海域海洋功能区水质目标',
                    align: 'center',
                    valign: 'middle'
                }],
    ...
    function exe() {
        ...
        if (val4 == true) {
            var temp4 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">港口码头名称</span>\n" +
        ...
        if (val5 == true) {
            var temp5 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">港口码头编号</span>\n" +
        ...
        if (val10 == true) {
            var temp10 = "    <div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">港口码头经度(N)</span>\n" +
        ...
        if (val11 == true) {
            var temp11 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">港口码头纬度</span>\n" +
        ...
        if (val12 == true) {
            var temp12 = "<div class=\"input-group\">\n" +
                "                                        <span class=\"input-group-addon\">港口码头范围</span>\n" +
